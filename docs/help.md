...
<section class="body"><iframe src="Component API.html" style="border: none" width="960px" height="1000px" scrolling="no"></iframe></section>
...
<article class="">[Close Document](#/close-document)
...
<article class="">[Append Text](#/append-text)

<section class="body"><iframe src="Append Text.html" style="border: none" width="960px" height="1300px" scrolling="no"></iframe></section>

</article>

<article class="">[Append Table](#/append-elements-table)

<section class="body">

<article class="">[Append Table (string)](#/append-table-string)
...
<article class="">[Append Table (double)](#/append-table-double)
...
<article class="">[Append Table As Strings (Malleable VI)](#/append-table-as-strings)
...
<article class="">[Append Image](#/append-image)
...
<article class="">[Read Text](#/read-text)

<section class="body"><iframe src="Read Text.html" style="border: none" width="960px" height="900px" scrolling="no"></iframe></section>

</article>

<article class="">[Read Table](#/retrieve-elements-table)

<section class="body">

<article class="">[Read Table As String](#/read-table-as-string)
...
<article class="">[Read Table (string)](#/read-table-string)
...
<article class="">[Read Table (double)](#/read-table-double)
...
<article class="">[Document Properties](#/document-properties)
...
<article class="">[Document Property Node](#/document-property-node)
...
<article class="">[Add New Page](#/add-new-page)
...
<article class="">[Remove Page](#/remove-page)
...
<article class="">[Convert To HTML](#/convert-to-html)
...
<article class="">[Print Document](#/print-document)
...
*   [Project](https://benji667.github.io/LabVIEW_NPOI/index)
*   [Discussions](https://github.com/Benji667/LabVIEW_NPOI/discussions)
*   [Issues](https://github.com/Benji667/LabVIEW_NPOI/issues)
*   [Repository](https://github.com/Benji667/LabVIEW_NPOI)
